...
if __name__ == '__main__':
    ...
    arg_parser.add_argument('-m', '--normalized', help='Forces APX to be generated in normalized form', action='store_true', default=False)
    ...
    if args.pipe:
        print(node.dumps(normalized=args.normalized))
    else:
        node.save_apx(output_file = output_file, normalized=args.normalized)