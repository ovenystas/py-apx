...
class TestApxVM(unittest.TestCase):
    ...
    def test_exec_pack_u8(self):
        ...
        vm.exec_instruction(apx.Instruction(apx.OPCODE_PACK_U8))
        self.assertEqual(data[0], 0)
        self.assertEqual(vm.data_offset, 1)
        vm.set_state_internal(data, 0, value = 0xAB)
        vm.exec_instruction(apx.Instruction(apx.OPCODE_PACK_U8))
        self.assertEqual(data[0], 0xAB)
        self.assertEqual(vm.data_offset, 1)
        vm.set_state_internal(data, 0, value = 0xFF)
        vm.exec_instruction(apx.Instruction(apx.OPCODE_PACK_U8))
    ...
    def test_exec_unpack_u8(self):
        ...
        self.assertIsNone(vm.value)
        data[0]=0
        vm.exec_instruction(apx.Instruction(apx.OPCODE_UNPACK_U8))
